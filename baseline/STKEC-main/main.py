...
def long_term_pattern(inputs,args):
    ...
    # print('long_pattern',long_pattern.shape)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--first_year_model_path", type = str, default = "res/PEMSD3/STKEC2025-01-09-21:13:05.655812/2011/15.9735.pkl", help='specify a pretrained model root')
    # parser.add_argument("--first_year_model_path", type = str, default = "res/PEMSD4/STKEC2025-01-09-21:27:02.755446/2009/24.403.pkl", help='specify a pretrained model root')
    parser.add_argument("--first_year_model_path", type = str, default = "res/PEMSD8/STKEC2025-01-09-21:37:02.196515/2012/16.5274.pkl", help='specify a pretrained model root')
